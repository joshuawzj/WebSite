...
public class FileManager : IHttpHandler
{
	public void ProcessRequest(HttpContext context)
	{
		...
		//根目录路径，相对路径
		String rootPath = WebUtil.Instance.AppPath() + AppSettingUtil.AppSettings["UploadFilePath"];
		//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
		String rootUrl = WebUtil.Instance.AppPath() + AppSettingUtil.AppSettings["UploadFilePath"];
        ...
        //图片扩展名
        String fileTypes = extTable[dirName].ToStr();
