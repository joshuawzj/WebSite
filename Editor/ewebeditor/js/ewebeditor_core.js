/*
*######################################
* eWebEditor V11.2 - Advanced online web based WYSIWYG HTML editor.
...
String.prototype.oz = function() { return this.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g, ''); };
...
(function() {
    ...
    var mZ = function(o) { return Object.prototype.toString.call(o) === "[object RegExp]"; };
...
var Ir = (function() {
    ...
    var Gj = function(Ft, flag) { return Ft + 22 + 75 * (Ft < 26) - ((flag != 0) << 5); };
    ...
    var FZ = function(Fh) {
        var Gg = [], Gn = Fh.length, out, i = 0, n = Fn, EP = Gt, FA, j, GJ, Gp, w, k, Ft, t, EQ;
        FA = Fh.lastIndexOf('-');
        if (FA < 0) {
            FA = 0;
        }
    ...
    var Hx = function(Fh) {
        var n, FF, GH, FK, EP, j, m, q, k, t, Fz, Gg = [], Gn, FJ, EQ, Fj;
        Fh = Fc(Fh);
        Gn = Fh.length;
        n = Fn;
        FF = 0;
    ...
    var Fb = function(Fh) { return Fr(Fh, function(s) { return Ij.test(s) ? FZ(s.slice(4).toLowerCase()) : s; }); };
    var Fa = function(Fh) { return Fr(Fh, function(s) { return Hk.test(s) ? 'xn--' + Hx(s) : s; }); };
    ...
    return {
        Hq: function(Fh) { return Fb(Fh); },
        HV: function(Fh) { return Fa(Fh); },
        Ii: function(Fh) { return Fv(Fh, false); },
        Hm: function(Fh) { return Fv(Fh, true); }
    };
})();
var aA = (function() {
    var iW = new Object();
...
var am = (function() {
    ...
    var mv = function() {
        ...
        kp =
            "<table border=0 cellpadding=0 cellspacing=0 class='Menu_Box' id=Menu_Box><tr><td class='Menu_Box'><table border=0 cellpadding=0 cellspacing=0 class='Menu_Table'>";
        bf =
            "<tr><td class='Menu_Sep'><table border=0 cellpadding=0 cellspacing=0 class='Menu_Sep'><tr><td></td></tr></table></td></tr>";
        ...
        if (F.as) {
            ...
            R.cP(aP, { position: 'absolute', zIndex: ut });
            aP.kw = window;
    ...
    var dY = function(aW, pP, jn, V) {
        ...
        if (aW == "") {
            dX +=
                "<tr><td class='Menu_Item'><table border=0 cellpadding=0 cellspacing=0 width='100%'><tr><td valign=middle class=MouseOut onMouseOver=\"this.className='MouseOver'\" onMouseOut=\"this.className='MouseOut'\" onclick=\"" +
                js +
                "\">";
        } else {
            dX +=
                "<tr><td class='Menu_Item'><table border=0 cellpadding=0 cellspacing=0 width='100%'><tr><td valign=middle class=MouseDisabled>";
        }
        aW = (aW) ? "_Disabled" : "";
    ...
    return {
        Show: function() {
            if (F.as) {
                ...
                R.cP(aP, { width: w + 'px', height: h + 'px', left: x + 'px', top: y + 'px' });
                gg = true;
            }
        },
        fJ: function(e, an) {
            ...
            case "fontsize":
                ...
                for (var i = 0; i < lang["FontSizeItem"].length; i++) {
                    if (lang["FontSizeItem"][i][0] == v) {
                        G += dY("",
                            "fq('size','" + lang["FontSizeItem"][i][0] + "')",
                            120,
                            lang["FontSizeItem"][i][1]);
                    } else {
                        G += dY("",
                            "fq('size','" + lang["FontSizeItem"][i][0] + "')",
                            119,
            ...
            case "formatblock":
                ...
                for
                (var i = 0; i < lang["FormatBlockItem"].length; i++) {
                    if (lang["FormatBlockItem"][i][0].toLowerCase() == v) {
                        G += dY("",
                            "format('FormatBlock','" + lang["FormatBlockItem"][i][0] + "')",
                            120,
...
var ec = (function() {
    ...
    var pj = function(el) { R.cP(el, { 'zIndex': ks() }); };
    var tu = function() {
        if (!cN) {
            cN = R.lJ();
            cg = cN.document;
        ...
        R.hh(cB);
        R.cP(cB, { "position": "absolute", "zIndex": ks(), "top": "0px", "left": "0px", "backgroundColor": "#ffffff" });
        R.rN(cB, 0.50);
        if (F.as && !F.gB) {
    ...
    return {
        OpenDialog: function(rz, fP) {
            ...
            var tI = { vz: cN, aR: window, Page: rz, Hide: fP };
            var ei = 160;
            var cq = 100;
            ...
            R.cP(dialog,
                { 'position': (sJ) ? 'absolute' : 'fixed', 'width': ei + 'px', 'height': cq + 'px', 'zIndex': ks() });
            if (fP) {
                R.cP(dialog, { 'top': '-10000px', 'left': '-10000px' });
            } else {
        ...
        wH: function(wd, Eh, kv) {
            ...
            if (dialog.la) {
                ...
                R.oQ(sk, 200, null, [{ flag: "DialogClose", ok: Eh }]);
                if (Eh) {
                    Et();
                }
            }
        ...
        oP: function(dialog, ei, cq) {
            ...
            R.cP(dialog, { 'top': dM + 'px', 'left': jq + 'px' });
        },
        yH: function() { return cB; },
        Ab: function() { return eP; }
    };
})();
var ci = (function() {
    var BO = 1;
    ...
    var kT = function() {
        ...
        var oa = {
            normal: [
                "Bold", "Italic", "UnderLine", "StrikeThrough", "SuperScript", "SubScript", "JustifyLeft",
                "JustifyCenter", "JustifyRight", "JustifyFull", "TextIndent"
            ],
...
var dN = (function() {
    ...
    var JL = function(el, IR, Kw) {
        ...
        dM = dM - JV.Y;
        jq = jq +
            $("eWebEditor").offsetLeft +
            $("eWebEditor_Layout").offsetLeft +
            jF(R.ce($("eWebEditor_EditareaTD"), "border-left-width")) +
            jF(R.ce($("eWebEditor"), "border-left-width"));
        dM = dM +
            $("eWebEditor").offsetTop +
            $("eWebEditor_Layout").offsetTop +
            $("eWebEditor_ToolarPTR").offsetHeight +
            jF(R.ce($("eWebEditor_EditareaTD"), "border-top-width")) +
            jF(R.ce($("eWebEditor"), "border-top-width"));
        Jb.style.left = jq + "px";
        Jb.style.top = dM + "px";
    ...
    var Jn = function() { return (!F.EY && !F.KT); };
    return {
        IX: function() {
            if (Jn()) {
...
var FT = (function() {
    ...
    var Gv = '<object type="application/x-ewebeditor-' +
        GF +
        '" id="obj_activex" height="0" width="0" progid="eWebSoft.eWebEditor' +
        GF +
        '" ></object>';
    var LO = 0;
    var Ff = false;
    ...
    var JI = function(If) {
        return ("|importstatus|cancel|version|error|style|body|originalfiles|savedfiles|".indexOf(
                "|" + If.toLowerCase() + "|") <
            0);
    };
    var GK = function(rs, HG) {
        ...
        IG.GW("post", aG, true, rs, function(HD) { HG(HD); });
    };
            ...
            GK(HS,
                function(GU) {
                    if (GU["XhrStatus"] == 200 && GU["Data"]["Status"] == "ok") {
                        if (
                            "|capture|localupload|showeq|importword|pasteword|importexcelsheet|pasteexcel|importppt|pastefilelist|pasteimage|execasync|mfuupload|"
                                .indexOf("|" + If + "|") >=
                                0) {
                            HS["Act"] = "status";
            ...
            if (JI(Iz)) {
                if (FT.HE) {
                    if (Ic) {
                        ...
                        FT.HK.push({ "Act": Iz, "Param": qD, "CallBack": zP });
                        window.setTimeout(FT.Im, 100);
                        return;
                    }
                } else {
...
var EWEB = {
    ...
    Init: function() {
        ...
        if (F.Ei) {
            window.onresize = function(e) { Dj(); };
        }
    }
};

function focus() { EWEB.Focus(); };
...
function Dj() {
    ...
    if (xv) {
        ...
        if (be.clientWidth > 0) {
            var He = R.eF(window);
            var GM = He.Width -
                BW(R.ce(document.body, "padding-left")) -
                BW(R.ce(document.body, "padding-right")) -
                BW(R.ce(document.body, "border-left-width")) -
                BW(R.ce(document.body, "border-right-width"));
            var Ip = He.Height -
                BW(R.ce(document.body, "padding-top")) -
                BW(R.ce(document.body, "padding-bottom")) -
                BW(R.ce(document.body, "border-top-width")) -
                BW(R.ce(document.body, "border-bottom-width"));
            ...
            var HC = Ip - GO - IC;
            var Ks = GM -
                BW(R.ce(be, "padding-left")) -
                BW(R.ce(be, "padding-right")) -
                BW(R.ce(be, "border-left-width")) -
                BW(R.ce(be, "border-right-width"));
            var Hf = HC -
                BW(R.ce(be, "padding-top")) -
                BW(R.ce(be, "padding-bottom")) -
                BW(R.ce(be, "border-top-width")) -
                BW(R.ce(be, "border-bottom-width"));
...
function ts() {
    ...
    if ((!EWEB.bs) && (config.ServerExt == "aspx")) {
        EWEB.bs = bF("input");
        if (!EWEB.bs) {
            EWEB.bs = bF("textarea");
        }
...
function lT() {
    ...
    sk({ flag: "LoadComplete" });
};

function Et() { R.oQ(sk, 400, null, [{ flag: "Change" }]); };
...
function bF(aH) {
    var K = parent.document.getElementsByTagName(aH);
    for (var i = 0; i < K.length; i++) {
        var ay = K[i].getAttribute("name");
        if (!ay) {
            continue;
        }
        var n = ay.lastIndexOf("$");
        if (n < 0) {
            n = ay.lastIndexOf(":");
        }
        if (n >= 0) {
...
function iT() { setHTML($("D_ContentLoad").value); };
...
function NH(e) {
    ...
    try {
        ...
        e.clipboardData.setData("text/plain", bE);
        e.preventDefault();
    } catch (er) {
    }
};
...
function insertHTML(V) {
    ...
    case "EDIT":
        ...
        if (!window.getSelection) {
            ...
            fA.deleteContents();
            var NN = false;
            if (/<(p|div|table|td|th|tr|h[1-9]|ul|ol)(?=[\s>])/gi.test(V)) {
                var Mj = C.cI();
                if (Mj && Mj != R.Lq()) {
                    var Nu;
                    var NK = R.Mv(Mj,
                        [
                            "P", "DIV", "TD", "TH", "TABLE", "UL", "OL", "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8",
                            "H9"
                        ]);
                    if (NK) {
                        if (R.KO(["P", "DIV", "UL", "OL", "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9"],
                                NK.tagName) >=
                            0) {
                            Nu = NK;
                        } else {
                    ...
                    var MP = Nu.innerHTML;
                    if
                    (/^(&nbsp;|\s|\u2002|\u2003|\u2009|&ensp;)*?$/gi.test(MP) || /^\s*?<br\/?>\s*?$/gi.test(MP)) {
                        fA.selectNode(Nu);
                        fA.deleteContents();
                    } else {
                        var Or = EWEB.T.createElement("span");
                        fA.insertNode(Or);
                        var NA = Nu.cloneNode(true);
                        var MW = 0;
                        var Om = [];
                        var Nz = Or;
                        while (Nz && Nz.tagName != "BODY" && Nz != Nu) {
                            Om[MW] = 0;
                            var NR = Nz.previousSibling;
                            while (NR) {
                                Om[MW] = Om[MW] + 1;
                        ...
                        var MA = Nu;
                        var mj = NA;
                        for (var i = MW - 1; i >= 0; i--) {
                            MA = MA.childNodes[Om[i]];
                            while (MA.nextSibling) {
                                R.cE(MA.nextSibling);
                            }
                            if (i == 0) {
                                R.cE(MA);
                            }
                            mj = mj.childNodes[Om[i]];
                            while (mj.previousSibling) {
                                R.cE(mj.previousSibling);
                            }
                            if (i == 0) {
                                R.cE(mj);
                            }
                        ...
                        if (NA.innerHTML != "") {
                            Nu.parentNode.insertBefore(NA, Nu.nextSibling);
                        }
                        Nu.parentNode.insertBefore(mW, Nu.nextSibling);
                        if (Nu.innerHTML == "") {
                            R.cE(Nu);
                        }
                        NN = true;
...
function setHTML(V, ub, Lk) {
    ...
    case "EDIT":
        ...
        if (F.EY) {
            if (config.FixWidth) {
                R.az(EWEB.T.getElementById("eWebEditor_FixWidth_DIV"), 'beforedeactivate', function() { C.Save(); });
            } else {
                R.az(EWEB.T, 'beforedeactivate', function() { C.Save(); });
            }
        }
        DN();
        break;
...
function kZ(el) {
    var sl = [
        "p", "div", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "ol", "ul", "fieldset", "form", "table", "tr",
        "blockquote", "dl", "li", "br"
    ];
...
function addUploadFile(cf, fo) {
    ...
    hY(aA.vZ, qN);
    hY(aA.vj, fo);
    sk({ flag: "AfterUploadOne", savepathfilename: fo, savefilename: qN, originalfilename: cf });
};
...
function localUpload() {
    ...
    FT.wQ("isinstalled",
        ...
        function(hT) {
            ...
            var fh = getHTML();
            FT.wQ("localupload", [fh], function(hT) { Ec(hT, ""); });
        });
};
...
function dw() { $("divProcessing").style.left = "-10000px"; };
...
function pG(V) {
    ...
    dS += '<link href="' + (window._appName||'/')+'Editor/Editor.css" type="text/css" rel="stylesheet">';
    dS += '<link href="' + QueryString("cssPath") + '" type="text/css" rel="stylesheet">';
    switch (EWEB.ae) {
    case 'CODE':
        break;
    case 'TEXT':
...
function ng(url) { document.write('<scr' + 'ipt type="text/javascript" src="' + url + '"><\/scr' + 'ipt>'); };

function wr() {
    if (!config.L) {
        document.write(
            "<table style='width:100%;height:100%;border-collapse:collapse' borderColor='#999999' bgColor='#ffffff' border='1px'><tr><td align='center' style='font-size:9pt'>eWebEditor!<br><br>" +
            lang["ErrLicense"] +
            "</td></tr></table>");
        return;
    }
    var bC = "";
    bC +=
        "<table id='eWebEditor_Layout' border='0' cellpadding='0' cellspacing='0' width='100%' height='100%' style='table-layout:fixed'>";
    ...
    bC +=
        "<textarea id='eWebEditorTextarea' style='display:none;width:100%;height:100%;' spellcheck='false' autocorrect='off'></textarea>";
    ...
    if (config.StateFlag) {
        ...
        if (config.SBCode) {
            bC +=
                "		<td class=SB_Mode_BtnOff id=eWebEditor_CODE onclick=\"setMode('CODE')\" unselectable=on><table border=0 cellpadding=0 cellspacing=0><tr><td class=SB_Mode_Btn_Img>" +
                ef("ModeCode") +
        ...
        if (config.SBEdit) {
            bC +=
                "		<td class=SB_Mode_BtnOff id=eWebEditor_EDIT onclick=\"setMode('EDIT')\" unselectable=on><table border=0 cellpadding=0 cellspacing=0><tr><td class=SB_Mode_Btn_Img>" +
                ef("ModeEdit") +
                "</td><td class=SB_Mode_Btn_Text>" +
                lang["StatusModeEdit"] +
                "</td></tr></table></td>";
        ...
        if (config.SBText) {
            bC +=
                "		<td class=SB_Mode_BtnOff id=eWebEditor_TEXT onclick=\"setMode('TEXT')\" unselectable=on><table border=0 cellpadding=0 cellspacing=0><tr><td class=SB_Mode_Btn_Img>" +
                ef("ModeText") +
                "</td><td class=SB_Mode_Btn_Text>" +
                lang["StatusModeText"] +
                "</td></tr></table></td>";
        ...
        if (config.SBView) {
            bC +=
                "		<td class=SB_Mode_BtnOff id=eWebEditor_VIEW onclick=\"setMode('VIEW')\" unselectable=on><table border=0 cellpadding=0 cellspacing=0><tr><td class=SB_Mode_Btn_Img>" +
                ef("ModeView") +
                "</td><td class=SB_Mode_Btn_Text>" +
                lang["StatusModeView"] +
                "</td></tr></table></td>";
    ...
    bC += "<form id='eWebEditor_UploadForm' action='" +
        EWEB.Nq +
        "&action=remote&type=remote' method='post' target='eWebEditor_UploadTarget'>";
    ...
    bC +=
        "<table border=0 cellpadding=0 cellspacing=1 bgcolor='#000000' width='100%' height='100%'><tr><td bgcolor=#3A6EA5><marquee id='msgProcessing' align='middle' behavior='alternate' scrollamount='5' style='font-size:9pt;color:#ffffff'></marquee></td></tr></table>";
    bC += "</div>";
    bC +=
        "<div id='div_TableResizeSepV' style='position:absolute;display:none;background-color:transparent;overflow:hidden;' onmousedown='cW.MD2(event)' onmousemove='cW.MM2(event)' onmouseup='cW.MU2(event)'></div>";
    bC +=
        "<div id='div_TableResizeSepH' style='position:absolute;display:none;background-color:transparent;overflow:hidden;' onmousedown='cW.MD2(event)' onmousemove='cW.MM2(event)' onmouseup='cW.MU2(event)'></div>";
    if (!F.EY && F.Bx) {
    ...
    if (!F.EY && !F.KT) {
        bC +=
            '<div id="ImgResize_Line_L" class="ImgResize_Line" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_Line_R" class="ImgResize_Line" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_Line_T" class="ImgResize_Line" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_Line_B" class="ImgResize_Line" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_LT" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_LM" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_LB" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_CT" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_CB" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_RT" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_RM" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>' +
            '<div id="ImgResize_C_RB" class="ImgResize_C" onmousedown="dN.MD2(event)" onmousemove="dN.MM2(event)" onmouseup="dN.MU2(event)"></div>';
    }
    document.write(bC);
};
    ...
    for (var i = 0; i < qH.length; i++) {
        ...
        for (var j = 0; j < tb.length; j++) {
            ...
            if (aM == "TBSep") {
                ...
                aI += "<td class='TB_Btn_Padding'><select name='TB_Name_" +
                    aM +
                    "' onchange=\"" +
                    hL +
                    "\" size=1 " +
...
aE.Fw = function(V) {
    ...
    var gC = function(m, m1) { return m.replace(/[ \t\n\r]*$/g, '') + '</' + m1 + '>'; };
    for (var i = 0; i < sO.length; i++) {
        sO[i] = sO[i].replace(
            /<(li|dd|dt)(?=[\s>])[^>]*>((?!<\/?(li|dd|dt)[\s>])[\s\S])*(?=<(li|dd|dt|\/ul|\/ol|\/dl)[\s>])/gi,
            gC)
    }
...
aE.ob = function(V, aH, um) {
    function _Replace(m) { return aE.ct(aH, m); };
...
aE.vb = function(V) {
    function _Replace(m, aH) {
        function gm(m, bv) {
            if ([
                    'flash', 'flv', 'mediaplayer6', 'mediaplayer7', 'realplayer', 'quicktime', 'vlc', 'video', 'audio',
                    'unknownobject'
                ].IndexOf(aH) >=
                0) {
                var ak = aE.pr(m, 'img');
                ...
                eu = aE.sv(eu,
                    ...
                    [["width", eh], ["height", ff], ["align", fQ], ["vspace", jB], ["hspace", gq]]);
                return eu;
            } else {
    ...
    function _Replace(m) {
        ...
        if (cT == 'application/x-shockwave-flash') {
            return aE.ct('flash', m, 'embed');
                ...
                'application/x-mplayer2', 'video/x-ms-asf', 'video/x-msvideo', 'video/mpeg', 'audio/mid', 'audio/mpeg',
                'audio/wav', 'video/x-ms-wm', 'audio/x-ms-wma', 'video/x-ms-wmv', 'video/x-ms-wmp', 'video/x-ms-wmx'
            ].IndexOf(cT) >=
            0) {
            return aE.ct('mediaplayer6', m, 'embed');
        } else if (cT == 'video/quicktime') {
            return aE.ct('quicktime', m, 'embed');
        } else if (['audio/x-pn-realaudio', 'audio/x-pn-realaudio-plugin', 'application/vnd.rn-realmedia']
            .IndexOf(cT) >=
            0) {
            return aE.ct('realplayer', m, 'embed');
        } else if
        (['application/x-vlc-plugin'].IndexOf(cT) >= 0) {
...
aE.LZ = function(V) {
    function _Replace(m) { return aE.ct('video', m, 'video'); };

    return V.replace(/<video[\s\S]*?<\/video>/gi, _Replace);
};
aE.KK = function(V) {
    function _Replace(m) { return aE.ct('audio', m, 'audio'); };
...
aE.ct = function(aH, bv, eJ) {
    if (eJ) {
        ...
        var V = '<img src="' +
            EWEB.cd +
            '/sysimage/space.gif" class="ewebeditor__' +
            aH +
            '" _ewebeditor_fake_tag="' +
            aH +
            '" _ewebeditor_fake_value="' +
...
aE.sX = function(V) {
    function _Replace(m) {
        function gC(m, bL) { return ' _ewebeditor_pe_' + bL + '="' + encodeURIComponent(m) + '"'; };
...
aE.sQ = function(V) {
    function _Replace(m, m1) { return decodeURIComponent(m1); };

    return V.replace(/\s_ewebeditor_pe_\w+=\"([^\"]+)\"/gi, _Replace);
};
aE.gS = function(V, aH, bL) {
    function _Replace(m, m1, m2) {
        var aF = m2.replace(/</gi, "&lt;");
        aF = aF.replace(/>/gi, "&gt;");
        return m1 + aF;
    };
    ...
    var re = new RegExp('(<' + aH + '\\s[^<>]*?' + fu + '\\s*?=\\s*?)(\"[^\"]*?[<>][^\"]*?\"|\'[^\']*?[<>][^\']*?\')',
        'gi');
    var aI = V.replace(re, _Replace);
    if (aI != V) {
        return aE.gS(aI, aH, bL);
    } else {
        return aI;
    }
};
...
var vy = {
    vi: function(V) {
        ...
        var gC = function(m, m1, m2) { return m1.toLowerCase() + m2; };
        ...
        var BB = function(m, m1, m2, m3) {
            ...
            var BC = function(m, m1, m2) { return ' ' + m1.toLowerCase() + '="' + m2 + '"'; };
...
function dB(aN) {
    ...
    case "code":
        insertHTML(
            '<table width=95% border="0" align="Center" cellpadding="6" cellspacing="0" style="border: 1px Dotted #CCCCCC; TABLE-LAYOUT: fixed"><tr><td bgcolor=#FDFDDF style="WORD-WRAP: break-word"><font style="color: #990000;font-weight:bold">' +
            lang["HtmlCode"] +
            '</font><br>' +
            FM(bE) +
            '</td></tr></table>');
    ...
    case "quote":
        insertHTML(
            '<table width=95% border="0" align="Center" cellpadding="6" cellspacing="0" style="border: 1px Dotted #CCCCCC; TABLE-LAYOUT: fixed"><tr><td bgcolor=#F3F3F3 style="WORD-WRAP: break-word"><font style="color: #990000;font-weight:bold">' +
            lang["HtmlQuote"] +
            '</font><br>' +
            FM(bE) +
            '</td></tr></table>');
    ...
    case "printbreak":
        insertHTML(
            "<div style=\"FONT-SIZE: 1px; PAGE-BREAK-BEFORE: always; VERTICAL-ALIGN: middle; HEIGHT: 1px; BACKGROUND-COLOR: #c0c0c0\">&nbsp; </div>");
        break;
    default:
        alert(lang["ErrParam"]);
        break;
...
kQ.eD = function() { ci.nT("other", "Maximize", this.hM); };
...
function Lc() {
    ...
    var bu = "wordeq:1;width:880;height:500;action:" +
        Iz +
        ";pointsize:" +
        bn +
        ";eqtype:" +
        ...
        function(hT) {
            ...
            if (fB[5] == "1") {
                ...
                FT.wQ("getclipboard",
                    ...
                    function(hT) {
                        var fh = hT["Ret"];
                        FT.wQ("localupload", [fh], function(hT) { Ec(hT, "dB"); });
                    });
                return;
            } else if (fB[5] == "4") {
                if (FT.FD()) {
...
var vp = (function() {
    ...
    var nV;
    var qq;
    var BV = function() { ci.nT("other", "FormatBrush", cV); };
    var fi = function(aV) {
        var v;
        switch (aV) {
        case "fontsize":
...
R.fR = function(J) { return ("CSS1Compat" == (J.compatMode || (F.ik ? "CSS1Compat" : null))); };
R.hh = function(kG) {
    kG.style.cssText =
        "margin:0;" + "padding:0;" + "border:0;" + "background-color:transparent;" + "background-image:none;";
};
R.dV = function(kG) { return kG.ownerDocument || kG.document; };
R.mh = function(kG) { return this.mD(this.dV(kG)); };
R.mD = function(J) { return J.parentWindow || J.defaultView; };
R.lJ = function() {
...
R.tz = function(bz, mL) { return R.Mv(bz, [mL]); };
R.Mv = function(bz, Jo) {
...
R.Lq = function() { return (config.FixWidth ? EWEB.T.getElementById("eWebEditor_FixWidth_DIV") : EWEB.T.body); };
R.Lg = function(bz) {
    if (bz &&
        bz.tagName &&
        ((bz.tagName == "BODY") || ((bz.tagName == "DIV") && (bz.getAttribute("id") == "eWebEditor_FixWidth_DIV")))) {
        return true;
    } else {
        return false;
    }
...
R.lE = function(hS) { hS.$ = function(Cu) { return hS.document.getElementById(Cu); }; };
R.iO = function() {
    if (F.as) {
        if (F.xZ) {
            return "javascript: '';";
...
R.eF = function(vY) {
    if (F.as) {
        ...
        if (nm) {
            return { Width: nm.clientWidth, Height: nm.clientHeight };
        } else {
            return { Width: 0, Height: 0 };
        }
    } else {
        return { Width: vY.innerWidth, Height: vY.innerHeight };
    }
};
R.gL = function(BM) {
    if (F.as) {
        var cl = BM.document;
        var fs = { X: cl.documentElement.scrollLeft, Y: cl.documentElement.scrollTop };
        if (fs.X > 0 || fs.Y > 0) {
            return fs;
        }
        return { X: cl.body.scrollLeft, Y: cl.body.scrollTop };
    } else {
        return { X: BM.pageXOffset, Y: BM.pageYOffset };
    }
};
R.rN = function(kG, qs) {
    if (F.as && !F.BX) {
...
R.ce = function(kG, hO) {
    if (F.as) {
        hO = hO.replace(/\-(\w)/g, function(CC, p1) { return p1.toUpperCase(); });
            ...
            if (nr) {
                ...
                if (bz) {
                    ...
                    if (R.KO(["P", "DIV"], aH) >= 0) {
                        if ((config.FixWidth) &&
                            (aH == "DIV") &&
                            (bz.getAttribute("id") == "eWebEditor_FixWidth_DIV")) {
                        } else {
...
C.ai = function() {
    if (F.as) {
        ...
        var cT = 'Text';
        var Dr = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, embed: 1, object: 1, ol: 1, ul: 1 };
        var Bd;
        try {
            Bd = this.bG();
        } catch (e) {
        ...
        if (Bd && Bd.rangeCount == 1) {
            ...
            if (nr.startContainer == nr.endContainer &&
                (nr.endOffset - nr.startOffset) == 1 &&
                nr.startContainer.nodeType == 1 &&
                Dr[nr.startContainer.childNodes[nr.startOffset].nodeName.toLowerCase()]) {
                cT = 'Control';
            }
        }
        return cT;
...
C.ww = function(el) {
    if (F.as) {
        ...
        if (iP.inRange(gF)) {
            ...
            if (((iP.compareEndPoints("StartToEnd", gF) < 0) && (iP.compareEndPoints("StartToStart", gF) > 0)) ||
                ((iP.compareEndPoints("EndToStart", gF) > 0) && (iP.compareEndPoints("EndToEnd", gF) < 0))) {
                return true;
            }
        }
        return false;
...
C.Os = function() {
    ...
    if (F.EY) {
        try {
            r = EWEB.T.queryCommandValue("FontName");
        } catch (e) {
            r = "";
        }
    } else {
...
function getMode() { return EWEB.ae; };
...
function CF() {
    ...
    if (C.ai() == "Control") {
        ...
        if (bg.tagName.toUpperCase() == "IMG") {
            if (!aE.BK(bg)) {
                var wx = aE.CL(bg, "src");
                sk({ flag: "SetTitleImage", src: wx, obj: bg });
            }
        }
    }
};
...
var Jz = (function() {
    ...
    return {
        KD: function(aV) { return Md[aV.toLowerCase()]; },
        Kk: function(aV) {
            var jE = Mr(aV, true);
            return jE["V"];
        },
