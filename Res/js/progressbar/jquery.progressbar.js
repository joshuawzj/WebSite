...
USAGE:
	...
	示例：  $('#bar2').progressBar(百分值比,{width: 420, height:13, boxImage:'../../res/js/progressbar/images/progressbar.gif',barImage: '../../res/js/progressbar/images/progressbg_greennew.gif' });
	后面的参数不能省，即$("#progressbar").progressBar(45)类似这种写法不正确，除非修改下面的defaults参数设置，否则每次必须后面的参数【guocheng】
*/
(function ($) {
    $.extend({
