 ...
 *模板路径：C:\wwwroot\WebSite\cn/template/include/top.html
       ...
       <menu>
           <ul class="ul clearfix" id="menu" type="Vertical" rel="li-relative">
               ...
               <li class="cont_box">
                   ...
                   <div class="ewm">
					<wtl:list runat="server"  columnid="14"><ItemTemplate><img src="<%=Whir.ezEIP.Web.SysManagePageBase.Insten.UploadFilePath %><%# Container.DataRow["logo"].ToReplace() %>"/></ItemTemplate></wtl:list>
                   </div>
                </li>
           </ul>
       </menu>
