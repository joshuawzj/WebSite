...
public class WxPayApi
{
    ...
    */
    public static WxPayData Micropay(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("MicroPay request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        LogHelper.Log("MicroPay response : " + response);
    ...
    */
    public static WxPayData OrderQuery(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("OrderQuery request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
        LogHelper.Log("OrderQuery response : " + response);
    ...
    */
    public static WxPayData Reverse(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("Reverse request : " + xml);

        string response = HttpService.Post(xml, url, true, timeOut);

        LogHelper.Log("Reverse response : " + response);
    ...
    */
    public static WxPayData RefundQuery(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("RefundQuery request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        LogHelper.Log("RefundQuery response : " + response);
    ...
    */
    public static WxPayData DownloadBill(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("DownloadBill request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        LogHelper.Log("DownloadBill result : " + response);
    ...
    */
    public static WxPayData ShortUrl(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("ShortUrl request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);
        LogHelper.Log("ShortUrl response : " + response);
    ...
    */
    public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("UnfiedOrder request : " + xml);
        string response = HttpService.Post(xml, url, false, timeOut);
        LogHelper.Log("UnfiedOrder response : " + response);
    ...
    */
    public static WxPayData Report(WxPayData inputObj, int timeOut)
    {
        ...
        LogHelper.Log("Report request : " + xml);

        string response = HttpService.Post(xml, url, false, timeOut);

        LogHelper.Log("Report response : " + response);
