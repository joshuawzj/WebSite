...
public class RefundQuery
{
    ...
    */
    ...
    {
        LogHelper.Log("RefundQuery is processing...");
        ...
        WxPayData result = WxPayApi.RefundQuery(data, 6);//提交退款查询给API，接收返回数据

        LogHelper.Log("RefundQuery process complete, result : " + result.ToXml());
