...
public partial class whir_system_UserControl_ContentControl_DetailsForm : SysControlBase
{
    /// <summary>
    /// 栏目ID
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ShowRow = ServiceFactory.DynamicFormService.GetEditRow(ColumnId, ItemID);
        }
    ...
    {
        IList<Form> listForm = new List<Form>();
                ...
                case FieldType.Picture:
                    {
                        ...
                        if (ShowRow != null && ShowRow[field.FieldName].ToStr()!="")
                        {
                            ...
                            {
                                cell.InnerHtml += "<a href='{0}' target='_blank'><img src='{0}' onerror=\"this.src='{1}res/images/nopicture.jpg'\" width='100' height='100' style='margin-right:5px;float:left;'></a>".FormatWith(
