<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="Seo.aspx.cs" Inherits="Whir_System_Module_Label_Seo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrap">
        ...
        <div class="panel">
            <div class="panel-heading"><%="置标生成器".ToLang()%></div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="panel panel-default">
                            <div class="panel-heading">置标</div>
                                        ...
                                        <div class="form_center">
                                            ...
                                            <div class="form-group" align="center">
                                                <div class="col-md-offset-4 col-md-6 ">
                                                    <input type="hidden" name="labelName" id="labelName" value="seo" />
