<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="Jurisdiction_subject.aspx.cs" Inherits="whir_system_module_developer_Jurisdiction_subject" %>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $("a[maincolumnid]").click(function () {
                ...
                whir.dialog.frame('<%="分配类别权限"%>',
                    "<%=SysPath%>module/security/Jurisdiction_category.aspx?columnid=" + columnid + "&maincolumnid=" + maincolumnid +
                    "&subjectId=" + subjectId + "&roleid=2&siteId=<%=SiteId%>&SubjectTypeId=<%=SubjectTypeId%>&jscallback=CategoryCallBack&ids=" + categoryids, 'showCategory', 500, 300);
        ...
        function CategoryCallBack(data, columnid, maincolumnid, subjectId) {
            $("a[maincolumnid='" + maincolumnid + "'][subjectid='" + subjectId + "']").attr("selectCategory", data);
        }
