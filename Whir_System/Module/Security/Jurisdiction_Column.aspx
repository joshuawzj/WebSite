<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="Jurisdiction_Column.aspx.cs" Inherits="Whir_System_Module_Security_Jurisdiction_Column" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            var arr = new Array();
            var zn_arr = new Array(); //中文名
            $("input[lang]").each(function (index) {
                arr[index] = $(this).attr("lang");
                zn_arr[index] = $(this).attr("functionname");
            });
            arr = unique(arr);
            zn_arr = unique(zn_arr);
            var str = "&nbsp;&nbsp;";
            for (i = 0; i < arr.length; i++) {
                str += " <input type=\"checkbox\"  name=\"selectColumn\" value=\"" + arr[i] + "\" functionname=\"" + zn_arr[i] + "\" />" + arr[i] + "";
            ...
            $("a[maincolumnid]").click(function () {
                ...
                whir.dialog.frame('<%="分配类别权限".ToLang()%>', "<%=SysPath%>module/security/Jurisdiction_category.aspx?columnid=" + columnid + "&maincolumnid=" + maincolumnid + "&roleid=<%=RoleId%>&siteId=<%=SiteId%>&jscallback=CategoryCallBack&ids=" + categoryids, 'showCategory', 500, 300);
            });
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="panel panel-default" id="Table_ColumnFunctionList" runat="server" visible="false">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="site_select" id="sampleSelect"></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="list-group-item ">
                                    <table width="100%" class=" table-hover">
                                        <tr style="height: 40px">
                                            ...
                                            <th>&nbsp;<a id="selectAll" style="cursor: pointer;"><%="全选".ToLang()%></a>/<a id="cancelAll" style="cursor: pointer;"><%="取消".ToLang()%></a>
                                            </th>
                                        </tr>
