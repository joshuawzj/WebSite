<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="Form_Edit.aspx.cs" Inherits="Whir_System_Module_Column_Form_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function openLinkAttr() {
            var dialogUrl = "LinkAttr_Select.aspx?FieldId=<%=FieldId %>&FormId=<%=FormId %>";
            var targetControl = $(this).attr("for");
            var dialog = whir.dialog.frame("<%="调用属性".ToLang()%>", dialogUrl, function () {
                var frameDocument = dialog.find("iframe").contents();
                var checked = frameDocument.find("input[type='radio'][name='linkattr']:checked");
                if (checked.length != 1) {
                    whir.toastr.warning("<%="请选择一个属性".ToLang()%>");
                    return;
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="FormList.aspx?ColumnId=<%=ColumnId%>" aria-expanded="true"><%=CurrentColumn.ColumnName%>-<%="表单".ToLang()%></a></li>
                    ...
                    <div class="panel panel-default panels col-md-4" style="width: 49%; margin-right: 5px; padding-left: 0px; padding-right: 0px">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="operate_foot">
                                ...
                                <div class="btn-group">
                                    <a href="javascript:addFieldToForm();" class="btn btn-sm btn-white"><%="批量添加".ToLang()%></a>
                        ...
                        <div class="form_center" style="width: 100%;">
                            <form id="formEdit" class="form-horizontal" form-url="<%=SysPath%>Handler/Module/Column/Form.aspx">
                                    ...
                                    <div class="col-md-9 ">
                                        <div class="input-group ">
                                            <input id="FieldName" name="FieldName" class="form-control" value="" required="true"
                                                maxlength="20" errormessage="<%="请输入2-20个字符的字母数字组合，以字母开头".ToLang() %>" />
                                ...
                                <div class="form-group" name="divMaxLength">
                                    ...
                                    <div class="col-md-9 ">
                                        <input id="MaxLength" name="MaxLength" class="form-control" min="0"
                                ...
                                <div class="form-group" name="divTipText">
                                ...
                                <div class="form-group" name="divWidth">
                                    ...
                                    <div class="col-md-9 ">
                                        <input id="Width" name="Width" class="form-control" value="" validationexpression="\d*" min="0" integer
                                            maxlength="4" />
                                    </div>
                                </div>
                                <div class="form-group" name="divHeight" style="display: none">
                                    ...
                                    <div class="col-md-9 ">
                                        <input id="Height" name="Height" class="form-control" value="" validationexpression="\d*" min="0" integer
                                            maxlength="4" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group" name="divImageUploadMode" style="display: none">
                                    ...
                                    <div class="col-md-9 ">
                                        <ul class="list">
                                            <li>
                                                <input type="radio" id="ImageUploadMode_1" checked="checked" name="ImageUploadMode" value="1" />
                                                <label for="ImageUploadMode_1">
                                                    <%="单图片".ToLang()%></label>
                                            </li>
                                            <li>
                                                <input type="radio" id="ImageUploadMode_2" name="ImageUploadMode"
                                                    value="2" />
                                ...
                                <div class="form-group" name="divImageUploadMode" style="display: none">
                                    ...
                                    <div class="col-md-9 ">
                                        <ul class="list">
                                            <li>
                                                <input type="radio" id="IsWatermark_1" checked="checked" name="IsWatermark" value="0" />
                                                <label for="IsWatermark_1">
                                                    <%="否".ToLang()%></label>
                                            </li>
                                            <li>
                                                <input type="radio" id="IsWatermark_2" name="IsWatermark" value="1" />
    ...
    <script type="text/javascript">
                                            ...
                                            if ("<%=Forms.FormId %>" == "0" && '<%=FormId %>' != '0') {
                                                ...
                                                whir.toastr
                                                    .warning('<%="未找到FieldID为{0}的字段对象,formlist.aspx?columnid={1}".ToLang().FormatWith(Forms.FieldId,ColumnId)%>');
                                                ...
                                                $('[name=IsAllowNull][value=<%=Forms.IsAllowNull.ToStr().ToLower()=="true"?"1":"0" %>]')
                                                    .prop("checked", "checked");
                                                $('[name=IsOnly][value=<%=Forms.IsOnly.ToStr().ToLower()=="true"?"1":"0" %>]').prop("checked", "checked");
                                                $('[name=IsReadOnly][value=<%=Forms.IsReadOnly.ToStr().ToLower()=="true"?"1":"0" %>]')
                                                    .prop("checked", "checked");
                                                ...
                                                $('[name=IsLengthCalc][value=<%=Forms.IsLengthCalc.ToStr().ToLower()=="true"?"1":"0" %>]')
                                                    .prop("checked", "checked");
                                                ...
                                                $("#ValidateExpression")
                                                    .val(
                                                    '<%= Forms.ValidateExpression!=null&&Forms.ValidateExpression.Contains("\\")?Forms.ValidateExpression.Replace("\\","\\\\"):Forms.ValidateExpression %>');
                                                switch ('<%=Field.FieldType %>') {
                                                    ...
                                                    case "9":
                                                        // 是/否
                                                        $('[name=BoolDefaultValue]').val('<%=Forms.DefaultValue %>');
                                                        break;
                                                    case "10":
                                                        // 图片
                                                        if ('<%=FormUpload.FormUploadId %>' == "0" || '<%=FormUpload.FormUploadId %>' == '') {
                                                            ...
                                                            $('[name=IsWatermark][value=<%=FormUpload.IsWaterMark.ToStr().ToLower()=="true"?"1":"0" %>]')
                                                                .prop("checked", "checked");
                                                            $("#FileExts").val('<%=FormUpload.FileExts %>');
                                                            $("#FileExts").attr("required", true);
                                                    ...
                                                    FieldName: {
                                                        validators: {
                                                            notEmpty: {
                                                                ...
                                                                message: '<%="请输入2-20个字符的字母数字组合，以字母开头".ToLang() %>'
                                                            }
                                                        }
                                                    }, FieldAlias: {
                                                        validators: {
                                            ...
                                            $('#formEdit').Validator(options,
                                                function (el) {
                                                    ...
                                                    $form.post({
                                                        success: function (response) {
                                                            if (response.Status == true) {
                                                                actionSuccess == "refresh" ? whir.toastr.success(response.Message, true, false) : whir.toastr.success(response.Message, true, false, "FormList.aspx?columnid=<%= ColumnId %>");
