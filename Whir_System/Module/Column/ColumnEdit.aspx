<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="ColumnEdit.aspx.cs" Inherits="Whir_System_Module_Column_ColumnEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <section>
                        ...
                        <% else if (CurrentColumn.ColumnId != 0)
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="ColumnList.aspx" aria-expanded="true"><%="栏目结构".ToLang() %></a></li>
                                <%} %>
                                <%if (IsRoleHaveColumnRes("栏目修改", CurrentColumn.ColumnId, -1))
                                    {%>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <% if (CurrentColumn.ColumnId == 0&& IsDevUser)
                                    { %>
                              <div id="single" class="tab-pane <%=CurrentColumn.ColumnId==0?"active":"" %>">
                                <form id="formSingle" class="form-horizontal" form-url="<%=SysPath%>Handler/Developer/Column.aspx">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 ">
                                                <input id="ColumnName" name="ColumnName" class="form-control" value="<%= CurrentColumn.ColumnName %>"
                                                       required="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 ">
                                                <input id="ColumnNameStage" name="ColumnNameStage" class="form-control" value="<%=CurrentColumn.ColumnNameStage%>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                              ...
                              <div id="multi" class="tab-pane">
                                    <form id="formMulti" class="form-horizontal" form-url="<%=SysPath%>Handler/Developer/Column.aspx">
                                        <div class="form-group">
                                            <div class="col-md-2 control-label" for="ParentId"><%="上级栏目：".ToLang()%></div>
                                            <div class="col-md-10 ">
                            ...
                            <% else if (CurrentColumn.ColumnId != 0)
                              ...
                              <form id="formSet" class="form-horizontal" form-url="<%=SysPath%>Handler/Developer/Column.aspx">
                              <div class="panel panel-default panels">
                                  ...
                                  <div class="panel-body">
                                      ...
                                      <%if (IsRoleHaveColumnRes("SEO设置", CurrentColumn.ColumnId, -1))
                                          {%>
                                        <div class="form-group">
                                            <div class="col-md-2 control-label" for="MetaTitle"><%="SEO标题：".ToLang()%></div>
                                            <div class="col-md-10 ">
                                                <input id="MetaTitle" name="MetaTitle" class="form-control" maxlength="200" value="<%=CurrentColumn.MetaTitle%>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-2 control-label" for="MetaKeyword"><%="SEO关键字：".ToLang()%></div>
                                            <div class="col-md-10 ">
                                               <textarea id="MetaKeyword" name="MetaKeyword" class="form-control" style="overflow-x: hidden;" maxlength="200"><%=CurrentColumn.MetaKeyword%></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-2 control-label" for="MetaDesc"><%="SEO描述：".ToLang()%></div>
                                            <div class="col-md-10 ">
                                                <textarea id="MetaDesc" name="MetaDesc" class="form-control" style="overflow-x: hidden;" maxlength="200"><%=CurrentColumn.MetaDesc%></textarea>
                                            </div>
                                        </div>
                                        <%} %>
                                       <div class="form-group">
                                                ...
                                                <div class="col-md-10 ">
                                                    <ul class="list">
                                                        <%if (CurrentColumn.ModuleMark != null && (CurrentColumn.ModuleMark.ToLower() == "content_v0.0.01" ||
                                                            ...
                                                            { %>
                                                        <li>
                                                            <input type="checkbox" id="IsRelated" value="1" />
                                                            <label for="IsRelated"><%="启用相关文章".ToLang()%></label>
                                                               <input type="hidden"  name="IsRelated"  />
                                                        </li>

                                                        <li>
                                                            <input type="checkbox" id="IsRedirect" value="1" />
                                                            <label for="IsRedirect"><%="启用转向链接".ToLang()%></label>
                                                               <input type="hidden"  name="IsRedirect"  />
                                                        </li>
                                                        <%} %>
                                                        <%if (Whir.Service.ServiceFactory.ColumnService.IsCategoryParent(ColumnId))
                                                            { %>
                                                        <li>
                                                            <input type="checkbox" id="IsCategory" value="1" />
                                                            <label for="IsCategory"><%="启用单独类别".ToLang()%></label>
                                                            <input type="hidden"  name="IsCategory"  />
                                                        </li>
                                                        <%} %>
                                                    </ul>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function checkCheckbox() {
            ...
            if ($("#IsRedirect").prop("checked")) {
                $("[name='IsRedirect']").val(1);
            }
            else
                $("[name='IsRedirect']").val(0);

            if ($("#IsRelated").prop("checked")) {
                $("[name='IsRelated']").val(1);
            }
            else
                $("[name='IsRelated']").val(0);
        }

        function Change() {

            if ($("#IsCategory").prop("checked")) {
                $("input[name='IsCategory']").val(1);
                $("#divIsCategoryPower").show();
            } else {
                $("input[name='IsCategory']").val(0);
                $("#divIsCategoryPower").hide();
                $("#IsCategoryPower_False").iCheck("check");
            }
        }
        //绑定值
        ...
        $("#IsRelated[value='<%=CurrentColumn.IsRelated.ToInt()%>']").prop("checked", "checked");
        $("#IsRedirect[value='<%=CurrentColumn.IsRedirect.ToInt()%>']").prop("checked", "checked");
        $("#IsCategory[value='<%=CurrentColumn.IsCategory.ToInt()%>']").prop("checked", "checked");
