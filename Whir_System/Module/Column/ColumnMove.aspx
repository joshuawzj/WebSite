<%@ Page Language="C#" AutoEventWireup="true" CodeFile="columnmove.aspx.cs" Inherits="whir_system_module_column_columnmove"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrap" id="ColumnMove">
        <div class="space15">
        </div>
        <div class="panel">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-md-10 ">
                        <ul class="list">
                            <li>
                                ...
                                <label for="ColumnMove_Child"><%="移动为目标栏目的子栏目".ToLang()%></label>
                            </li>
                            <li>
                                <input type="radio" id="ColumnMove_Before" name="ColumnMove" value="Before" />
                                <label for="ColumnMove_Before"><%="移动到目标栏目之前".ToLang()%></label>
                            </li>
                            <li>
                                <input type="radio" id="ColumnMove_After" name="ColumnMove" value="After" />
                                <label for="ColumnMove_After"><%="移动到目标栏目之后".ToLang()%></label>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="form-group" >
                    <div class="col-md-offset-2 col-md-6 ">
                        ...
                        <button form-action="submit" form-success="refresh" class="btn btn-info btn-block"><%="提交".ToLang()%></button>
                    </div>
                </div>
            </div>
        </div>
         ...
         $('[form-action="submit"]')
             .click(function() {
                 if ($("#Origin").val() == "") {
                     ...
                     whir.ajax.post("<%=SysPath%>Handler/Developer/Column.aspx?_action=ColumnMove",
                         {
                             data: {
                                 Origin: $("#Origin").val(),
                                 Target: $("#Target").val(), 
