<%@ Page Title="" Language="C#" MasterPageFile="~/Whir_System/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="templateloglist.aspx.cs" Inherits="Whir_System_Module_log_templateloglist" %>
    ...
    <div class="mainbox">
        <dl class="title_column">
            <a href="operationloglist.aspx"><b><%="网站操作日志".ToLang() %></b></a> <em class="line"></em><a href="templateloglist.aspx"
                class="aSelect"><b><%="模板操作日志".ToLang() %></b></a> <em class="line"></em><a href="systemloglist.aspx">
                    <b><%="系统运行日志".ToLang() %></b></a>
        </dl>
            ...
            <table id="ta_list" width="100%" border="0" cellspacing="0" cellpadding="0" class="Table">
                ...
                <asp:Repeater ID="rptOperationLogs" runat="server" OnItemDataBound="rptOperationLogs_ItemDataBound"
                    ...
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                                <input type="checkbox" name="cb_Position" name="cbLog" value='<%# Eval("OperateId")%>' />
                            </td>
                            <td>
                                <%# Eval("OperateId")%>
                            </td>
