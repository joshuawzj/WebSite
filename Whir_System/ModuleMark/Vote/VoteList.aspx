<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="VoteList.aspx.cs" Inherits="Whir_System_ModuleMark_Vote_VoteList" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="actions btn-group pull-left">
                        <%if (IsRoleHaveColumnRes("添加"))
                          { %>
                        <a class="btn btn-white" href="Content_edit.aspx?columnid=<%=ColumnId%>&BackPageUrl=<%=CurrentPageUrl%>&subjectid=<%=SubjectId%>">
