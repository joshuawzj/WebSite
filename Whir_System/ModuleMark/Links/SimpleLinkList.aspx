<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="SimpleLinkList.aspx.cs" Inherits="Whir_System_ModuleMark_Links_SimpleLinkList"%>
            ...
            <div class="panel-body">
               ...
               <div class="actions btn-group pull-left">
                         ...
                         <%if (IsRoleHaveColumnRes("添加"))
                          { %>
                        <a class="btn btn-white" href="SimpleLink_Edit.aspx?&columnid=<%=ColumnId%>&subjectid=<%=SubjectId%>&BackPageUrl=<%=CurrentPageUrl%>">
