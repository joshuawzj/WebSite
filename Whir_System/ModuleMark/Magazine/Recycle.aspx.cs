...
public partial class Whir_System_ModuleMark_Magazine_Recycle : Whir.ezEIP.Web.SysManagePageBase
{
    #region 属性
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ContentID = RequestUtil.Instance.GetQueryInt("itemid", 0);
        ...
        if (ContentID > 0)
            contentManager1.Where = "MagazineID=" + ContentID;
