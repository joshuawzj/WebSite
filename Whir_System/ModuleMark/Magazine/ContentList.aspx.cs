...
public partial class Whir_System_ModuleMark_Magazine_ContentList : Whir.ezEIP.Web.SysManagePageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentActivityId = RequestUtil.Instance.GetQueryInt("flowid", -1);
        ...
        contentManager1.IsShowArticle = IsRoleHaveColumnRes("文章管理");
