...
public partial class Whir_System_ModuleMark_Jobs_ContentList : SysManagePageBase
{
    /// <summary>
    /// 当前的主栏目ID
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        contentManager1.IsShowJobRequest = IsRoleHaveColumnRes("应聘信息"); 
        ...
        contentManager1.DetailUrl = "ContentDetails.aspx?columnid=" + ColumnId + "&itemid={itemid}&subjectid=" + SubjectId;
