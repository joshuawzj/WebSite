<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="Form_Edit.aspx.cs" Inherits="Whir_System_ModuleMark_Member_Form_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li><a href="FormList.aspx" aria-expanded="true"><%="会员模型".ToLang() %></a></li>
                    <li class="active"><a href="<%=Request.Url%>" data-toggle="tab" aria-expanded="true">编辑表单</a></li>
                </ul>
                ...
                <asp:PlaceHolder ID="phFields" runat="server">
                    <div class="col-md-6">
                        <div class="panel panel-default panels">
                            ...
                            <div class="panel-body">
                                <div class="fromdit-all-list tableCategory-table-body">
                                            ...
                                            <asp:Repeater ID="rptFieldList" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='javascript:;GetLinkAttr(<%# Eval("FieldId") %>)'>&gt;&gt;</a>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                ...
                                <div class="operate_foot">
                                    ...
                                    <div class="btn-group">
                                        <a href="javascript:addFieldToForm();" class="btn btn-sm btn-white"><%="批量添加到表单".ToLang()%></a>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default panels">
                        <div class="panel-heading"><%="表单项信息".ToLang()%></div>
                        <div class="panel-body">
                            <div class="form_center" style="width: 100%;">
                                <form id="formEdit" class="form-horizontal" form-url="<%=SysPath%>Handler/Module/Column/Form.aspx">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 ">
                                            <div class="input-group ">
                                                ...
                                                <span class="input-group-addon pointer" id="divLinkAttr" onclick=" openLinkAttr();" for="hidLinkFormId"><%="调用属性".ToLang() %></span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 ">
                                            <input id="FieldAlias" name="FieldAlias" class="form-control" value="" required="true" maxlength="20" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="IsOnly_True"><%="是".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="IsOnly_False" checked="checked" name="IsOnly" value="0" />
                                                    <label for="IsOnly_False"><%="否".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="IsReadOnly_True"><%="是".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="IsReadOnly_False" checked="checked" name="IsReadOnly" value="0" />
                                                    <label for="IsReadOnly_False"><%="否".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="IsColor_True"><%="启用".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="IsColor_False" checked="checked" name="IsColor" value="0" />
                                                    <label for="IsColor_False"><%="不启用".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="IsBold_True"><%="启用".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="IsBold_False" checked="checked" name="IsBold" value="0" />
                                                    <label for="IsBold_False"><%="不启用".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="LengthCalc_True"><%="启用".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="LengthCalc_False" checked="checked" name="IsLengthCalc" value="0" />
                                                    <label for="LengthCalc_False"><%="不启用".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" name="divValidateType">
                                        ...
                                        <div class="col-md-9 ">
                                            <select id="ValidateType" name="ValidateType" class="form-control">
                                                ...
                                                <option value="<%="电子邮箱".ToLang()%>"><%="电子邮箱".ToLang()%></option>
                                                <option value="<%="手机号码".ToLang()%>"><%="手机号码".ToLang()%></option>
                                                <option value="<%="电话号码".ToLang()%>"><%="电话号码".ToLang()%></option>
                                                <option value="<%="手机号码/电话号码".ToLang()%>"><%="手机号码/电话号码".ToLang()%></option>
                                                <option value="<%="QQ".ToLang()%>"><%="QQ".ToLang()%></option>
                                                <option value="<%="身份证号码".ToLang()%>"><%="身份证号码".ToLang()%></option>
                                                <option value="<%="金额".ToLang()%>"><%="金额".ToLang()%></option>
                                                <option value="<%="数字".ToLang()%>"><%="数字".ToLang()%></option>
                                                <option value="<%="整数".ToLang()%>"><%="整数".ToLang()%></option>
                                                <option value="<%="正整数".ToLang()%>"><%="正整数".ToLang()%></option>
                                                <option value="<%="负整数".ToLang()%>"><%="负整数".ToLang()%></option>
                                                <option value="<%="非负整数".ToLang()%>"><%="非负整数".ToLang()%></option>
                                                <option value="<%="日期".ToLang()%>"><%="日期".ToLang()%></option>
                                                <option value="<%="日期时间".ToLang()%>"><%="日期时间".ToLang()%></option>
                                                <option value="<%="中文".ToLang()%>"><%="中文".ToLang()%></option>
                                                <option value="<%="英文".ToLang()%>"><%="英文".ToLang()%></option>
                                                <option value="<%="Url地址".ToLang()%>"><%="Url地址".ToLang()%></option>
                                                <option value="<%="安全字符".ToLang()%>"><%="安全字符".ToLang()%></option>
                                                <option value="<%="长度".ToLang()%>"><%="长度".ToLang()%></option>
                                                <option value="<%="邮编".ToLang()%>"><%="邮编".ToLang()%></option>
                                                <option value="<%="IP地址".ToLang()%>"><%="IP地址".ToLang()%></option>
                                                <option value="<%="自定义表达式".ToLang()%>"><%="自定义表达式".ToLang()%></option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="SelectedType_1"><%="下拉列表框".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="SelectedType_2" name="SelectedType" value="2" />
                                                    <label for="SelectedType_2"><%="单选按钮组".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="SelectedType_3" name="SelectedType" value="3" />
                                                    <label for="SelectedType_3"><%="多选按钮组".ToLang()%></label>
                                                </li>
                                                <li>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="DateFormat_1"><%="类似2012-08-25 17:16:30".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="DateFormat_2" name="DateFormat" value="yyyy-mm-dd" />
                                                    <label for="DateFormat_2"><%="类似2012-08-25".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="DateDefaultValue_1"><%="无".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="DateDefaultValue_2" checked="checked" name="DateDefaultValue" value="2" />
                                                    <label for="DateDefaultValue_2"><%="当前时间".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="DateDefaultValue_3" name="DateDefaultValue" value="3" />
                                                    <label for="DateDefaultValue_3"><%="指定日期".ToLang()%></label>
                                                </li>
                                            </ul>
                                            <input id="txtDateDefaultValue" name="txtDateDefaultValue" class="form-control" style="display: none" value="" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="ImageUploadMode_1"><%="单图片".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="ImageUploadMode_2" checked="checked" name="ImageUploadMode" value="2" />
                                                    <label for="ImageUploadMode_2"><%="多图片".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    ...
                                                    <label for="IsWatermark_1"><%="否".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="IsWatermark_2" checked="checked" name="IsWatermark" value="1" />
                                                    <label for="IsWatermark_2"><%="是".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="form-group" name="divFileUploadMode" style="display: none">
                                        ...
                                        <div class="col-md-9 ">
                                            <ul class="list">
                                                <li>
                                                    <input type="radio" id="FileUploadMode_1" checked="checked" name="FileUploadMode" value="1" />
                                                    <label for="FileUploadMode_1"><%="单文件".ToLang()%></label>
                                                </li>
                                                <li>
                                                    <input type="radio" id="FileUploadMode_2" name="FileUploadMode" value="2" />
                                                    <label for="FileUploadMode_2"><%="多文件".ToLang()%></label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="form-group" name="divFileExts" style="display: none">
                                        ...
                                        <div class="col-md-9 ">
                                            <input id="FileExts" name="FileExts" class="form-control" value="" maxlength="200" validationexpression="^[A-z|0-9]{0,200}$" />
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-md-9 ">
                                            ...
                                            <a class="btn btn-white" href="FormList.aspx?columnid=<%= ColumnId %>"><%="返回".ToLang()%></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script type="text/javascript">
        ...
        if ("<%=Forms.FormId %>" == "0" && '<%=FormId %>' != '0') {
            whir.toastr.warning('<%="未找到FormID为{0}的表单输入对象,formlist.aspx?columnid={1}".ToLang().FormatWith(FormId,ColumnId)%>');
                                                }
                                                else if ("<%=Field.FieldId %>" == "0" && '<%=FieldId %>' != '0') {
                                                    whir.toastr
                                                        .warning('<%="为找到FieldID为{0}的字段对象,formlist.aspx?columnid={1}".ToLang().FormatWith(Forms.FieldId,ColumnId)%>');
                                                ...
                                                $('#formEdit').Validator(options,
                                                    function (el) {
                                                        ...
                                                        $form.post({
                                                            success: function (response) {
                                                                if (response.Status == true) {
                                                                    actionSuccess == "refresh" ? whir.toastr.success(response.Message, true, false) : whir.toastr.success(response.Message, true, false, "FormList.aspx");
                                                                } else {
                                                                    whir.toastr.error(response.Message);
                                                                }
                                                                whir.loading.remove();
