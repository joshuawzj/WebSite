<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    CodeFile="ProductList.aspx.cs" Inherits="Whir_System_ModuleMark_Product_ProductList" %>
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <% if (item.MarkType == "Category")
                        {%>
                    <li>
                        <a href="<%="{0}modulemark/Product/categorylist.aspx?columnid={1}&subjectid={2}".FormatWith(SysPath, item.ColumnId, SubjectId) %>">
