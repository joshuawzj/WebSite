<%@ Page Title="" Language="C#" MasterPageFile="~/Whir_System/Master/SystemMasterPage.master" AutoEventWireup="true" CodeFile="Reply.aspx.cs" Inherits="Whir_System_Plugin_Wx_Reply" %>
                ...
                <div class="panel">
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="Reply.aspx"><%="关注自动回复".ToLang()%></a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
         ...
         $('#btn-save').click(function () {
             var dataType = $('div.btn-radio').find('> div.checked').attr('data-val'), data = { _action: 'SaveReply', id: id, replyType: '1' };
             switch (dataType) {
                 case 'text':
