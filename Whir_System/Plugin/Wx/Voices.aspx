<%@ Page Title="" Language="C#" MasterPageFile="~/Whir_System/Master/SystemMasterPage.master" AutoEventWireup="true" CodeFile="Voices.aspx.cs" Inherits="Whir_System_Plugin_Wx_Voices" %>
            ...
            <div class="col-lg-12">
                ...
                <label style="float: right;"><%="当前公众号".ToLang() %>：<%=this.CurrentCredence!=null?this.CurrentCredence.AppName+"（"+this.CurrentCredence.AppId+"）":("<a class=\"btn-empty-wx\" href=\"WxCredence.aspx\">"+"未设置当前公众号，点击进行设置".ToLang()+"</a>")%></label>
                    ...
                    <div class="panel-body">
                        <div style="margin: 0 10px 0 0;" class="actions btn-group pull-left" title="2M，播放长度不超过60s，mp3/wma/wav/amr格式">
                            <input id="data-file" name="data-file" type="file" />
                        </div>
                        <div class="actions btn-group pull-left" style="margin-right: 10px;">
                            <a id="btn-async" class="btn btn-white" href="javascript:void(0);"><%="同步语音素材".ToLang()%></a>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            $table.bootstrapTable({
                url: "<%=SysPath%>Plugin/Wx/Ajax/Ajax.aspx?_action=GetMedias&media=voice",
                dataType: "json",
                pagination: true, //分页
        ...
        $('#data-file').fileinput({
            ...
            uploadExtraData: { _action: 'UploadMedia', media: 'voice' }
        ...
        }).on('fileuploaderror', function (a, b, errText) {
        ...
        $('#btn-async').click(function () {
            whir.dialog.confirm("<%="同步所有语音素材信息可能需要花较长时间，确定同步吗？".ToLang() %>", function () {
