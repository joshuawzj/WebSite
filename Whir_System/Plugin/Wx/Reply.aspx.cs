...
public partial class Whir_System_Plugin_Wx_Reply : WxBasePage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (credence != null) {
            this.ViewData = WxReplyRepository.Find(credence.AppId, Senparc.Weixin.MP.ReplyType.Subscribe).FirstOrDefault();
        }
