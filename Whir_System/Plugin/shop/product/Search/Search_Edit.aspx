<%@ Page Title="" Language="C#" MasterPageFile="~/whir_system/master/SystemMasterPage.master"
    AutoEventWireup="true" CodeFile="search_edit.aspx.cs" Inherits="whir_system_Plugin_shop_product_search_search_edit" %>
                ...
                <div id="single" class="tab-pane active">
                    <form id="formEdit" class="form-horizontal" form-url="<%=SysPath%>Handler/Plugin/shop/SearchForm.aspx">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 ">
                                <input id="SearchName" name="SearchName" class="form-control" maxlength="30"
                                    value="<%=ShopSearch.SearchName %>" required="true" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10 ">
                                <input type="hidden" name="_action" value="SaveSearchEdit" />
