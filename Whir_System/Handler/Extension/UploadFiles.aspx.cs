...
public partial class Whir_System_Handler_Extension_UploadFiles : SysHandlerPageBase
{
    ...
    {
        var handlerResult = SysManagePageBase.JudgeActionPermission(SysManagePageBase.IsCurrentRoleMenuRes("312"));
    ...
    {
        var handlerResult = SysManagePageBase.JudgeActionPermission(SysManagePageBase.IsCurrentRoleMenuRes("315"));
        if (handlerResult.Status)
        {
            return new HandlerResult { Status = false, Message = handlerResult.Message };
        }
    ...
    public void GetList()
    {
        SysManagePageBase.JudgeActionPermission(SysManagePageBase.IsCurrentRoleMenuRes("33"), true);
        ...
        if (allowFileType.IsEmpty())
        {
            ...
            extensionNames = uploadConfig.AllowFileType;
        }
        else
